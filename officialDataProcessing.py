...
def processed_df():
    ...
    #X4, X13, X15 and X16 are all relationally dependent on other features
    #Since all financial relationships have separable variables
    #Every financial relationship can be defined linearly
    #Therefore these features are linearly dependant and can be removed
